...
import 'package:food_assigment/Food%20data/Catogory_list.dart';
import 'package:food_assigment/Food%20data/Food_data.dart';
import 'package:food_assigment/Food%20data/hotel_list.dart';
import 'package:food_assigment/Food%20pages/Profile.dart';
import 'package:food_assigment/Food%20pages/abt_food.dart';
import 'package:food_assigment/Imports.dart';
import 'package:food_assigment/State_class/Statemanage_class.dart';
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image:
                                      AssetImage('assets/image/profiles.png'),fit: BoxFit.cover)),
                        )
                      ],
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      bool isSelected = index == ms.selectedCategoryIndex;
                      return InkWell(
                        onTap: () {
                          ms.updateSelectedCategory(index);
                          Get.to(abtfood(
